  ...
  if(ThisTask == 0)		/* read parameter file on process 0 */
    {
      ...
      /* KC 8/9/14 Add parameters for reading in which gravity is used for each type */
      strcpy(tag[nt], "GravityHalo");
      addr[nt] = &All.GravityHalo;
      id[nt++] = INT;

      strcpy(tag[nt], "GravityDisk");
      addr[nt] = &All.GravityDisk;
      id[nt++] = INT;

      strcpy(tag[nt], "GravityBulge");
      addr[nt] = &All.GravityBulge;
      id[nt++] = INT;

      strcpy(tag[nt], "GravityGas");
      addr[nt] = &All.GravityGas;
      id[nt++] = INT;

      strcpy(tag[nt], "GravityStars");
      addr[nt] = &All.GravityStars;
      id[nt++] = INT;

      strcpy(tag[nt], "GravityBndry");
      addr[nt] = &All.GravityBndry;
      id[nt++] = INT;
